...
>
> `copilot_cli` currently fails closed unless the installed Copilot CLI version is exactly `1.0.85`, the version whose tool-deny behavior is verified by this release.
