...
| `SKILLSPECTOR_OUTPUT_LANGUAGE` | Optional language for human-readable LLM finding text. Rule IDs, severity values, paths, code, and other machine-readable values remain unchanged. Unset or blank preserves the default output language. | `Japanese` |
